...
module.exports = defineConfig({
  testDir: '.',
  testMatch: /phase8-(?:admin|fixture)\.spec\.js/,
  timeout: 45_000,
  ...
  retries: 0,
  workers: 1,
  reporter: [['line'], ['html', { open: 'never', outputFolder: '../playwright-report/phase8' }]],
  // Phase 8 consumes the immutable Phase 1 legacy baselines. A failing comparison
